          ...
          children: [
            Consumer<AuthModel>(
              builder: (_, model, child) {
                return  Container(
                  padding: EdgeInsets.only(right: 05,left: 10),
                  ...
                  child: model.appStatus==LoadStatus.LoadingLogin?
                  Container(
                    height: 120,
                    child: Row(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(child: Column(children: [
                        Text(model.isLoggedIn?'Email to SMS is working...':
                        'Email to SMS not working...',style: TextStyle(
                            fontSize: 18
                        ),),
                        Text('You can use settings to configure your mail',style: TextStyle(
                            fontSize: 14
                        ),),
                      ],
